...
def get_pixel_dist(pixel, red, green, blue):
    ...
    """
    r_diff = pixel.red - red
    g_diff = pixel.green - green
    b_diff = pixel.blue - blue
...
def get_average(pixels):
    ...
    if num_pixels > 0:
        ...
        average_red = average_green = average_blue = 0  # 避免除以0的錯誤
...
def get_best_pixel(pixels):
    ...
    for pixel in pixels:
        dist = get_pixel_dist(pixel, *average_rgb)
        if dist < min_dist:
            min_dist = dist
            best_pixel = pixel
...
def solve(images):
    ...
    for x in range(width):
        for y in range(height):
            ...
            # Set the best pixel's RGB values to the result image
